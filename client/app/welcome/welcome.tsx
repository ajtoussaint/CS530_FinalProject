...
export function Welcome(){
  ...
  const SvgTransition: React.FC<SvgTransitionProps> = ({
    ...
    let thetaR = xdist == 0 ? Math.PI : Math.atan(ydist / xdist)
        ...
        className="w-full h-full bg-purple-300 max-w-full max-h-full overflow-auto rounded-lg">
          ...
          >
            ...
            <marker id="arrowhead" markerWidth="5" markerHeight="3.5" refX="5" refY="1.75" orient="auto">
              ...
              <SvgTransition charName="a" x1={130} y1={70} x2={370} y2={70} upper={true} />
              <SvgTransition charName="a" x1={130} y1={130} x2={370} y2={370} upper={false} />
            </svg>
          </div>
        </div>
      </div>
